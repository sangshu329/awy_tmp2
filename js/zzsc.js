    ...
    win.slider={
        ...
        animateIn:function(i){
            ...
            that.changeBg(bg, function () {
                ...
                o.find('.banner-img').eq(3).animate({'left':'0'},that.speed+600,'easeOutCubic');
        ...
        animateOut:function(i,callback){
            ...
            o.find('.banner-img').eq(3).animate({'left':'200%'},that.speed+600,'easeOutCubic',function(){
                o.find('.banner-img').eq(3).css({'left':'-200%'});
            });
        },
        nextSlider:function(){
